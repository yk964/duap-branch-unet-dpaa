...
def main():
    ...
    # Data loading code
    img_paths = glob('/data/yike/nnunet/raw/LITS_free128/imagesTr/*')
    mask_paths = glob('/data/yike/nnunet/raw/LITS_free128/labelsTs/*')
    ...
    model = UNet3D.My_UNet3d(in_channels=1, n_classes=1, n_channels=32)
    ...
    log = pd.DataFrame(index=[], columns=[
        'epoch', 'lr', 'loss', 'iou','dice_1', 'val_loss', 'val_iou','val_dice_1', 'val_dice_2'
    ])
    ...
    for epoch in range(args.epochs):
        ...
        print('loss %.4f - iou %.4f - dice_1 %.4f  - val_loss %.4f - val_iou %.4f - val_dice_1 %.4f '
